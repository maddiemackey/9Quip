...
export default class PlayerList extends React.Component {
  ...
  formatPlayers() {
    ...
    this.state.players.forEach((players, i) => {
      ...
      if ((i+1)%5 === 0){
        this.setState({formattedPlayers: [...this.state.formattedPlayers, rowPlayers]});
        rowPlayers = [];
      }
    });
    this.setState({formattedPlayers: [...this.state.formattedPlayers, rowPlayers]});
    ...
    return (
      <div>
        <div className="players">
            ...
            {this.state.players.length === 0  && (
              <div style={{display: "flex", height: "100%", marginTop: "25vh", alignItems: "center", justifyContent: "center"}}>
